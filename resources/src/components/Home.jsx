...
const projects = [
  ...
  { proj: "p2", title: "Tic Tac Toe Part-1", description: "A famous game given in the React Official Tutorial" },
  { proj: "p3", title: "Tic Tac Toe Part-2", description: "Adding Move History - Trave Back to any Move" },
